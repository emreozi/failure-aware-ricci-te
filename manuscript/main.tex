...
versioned reproducibility artifact. A new archival version containing the
submission-upgrade outputs will be deposited on Zenodo and its DOI inserted
before submission. The external REPETITA source commit and dataset path are
recorded in the artifact; benchmark data retain their original attribution and
license \cite{gay2017repetita}.
