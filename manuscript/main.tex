...
\input{tables/table_closest_work.tex}
...
\input{tables/table1_topologies.tex}
...
\input{tables/table_scenario_sensitivity.tex}
...
\input{tables/table_adaptive.tex}
...
versioned reproducibility artifact. The development repository is available at
\url{https://github.com/emreozi/failure-aware-ricci-te}, and the exact v3.0.0
submission artifact is archived on Zenodo at
\href{https://doi.org/10.5281/zenodo.21375484}{doi:10.5281/zenodo.21375484}.
The external REPETITA source commit and dataset path are recorded in the
artifact; benchmark data retain their original attribution and license
\cite{gay2017repetita}.
